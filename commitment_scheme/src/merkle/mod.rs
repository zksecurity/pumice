...
mod tests {
    ...
    fn test_compute_root_with() {
        ...
        let root_exp =
            hex_to_vec("8eacf88fcb82bed025b069d23d41a3b3d7902e6e8279b3e1de42ce43061008");
        test_compute_root::<Felt252, Poseidon3<Felt252>>(&input, root_exp);
    ...
    fn test_verify_false_with() {
        ...
        let root_exp =
            hex_to_vec("c89ae25f3fa9f809dc7e255509bbe13d8ee41e7050a1757d10b14380479762");
        let to_verify = [(
            0,
            hex_to_vec(
